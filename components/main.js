...
orbitControls.enabled = true;
    ...
    // (Optional) Comment out or remove existing ambient/hemisphere lights if you want to rely purely on HDR:
    ...
    // Directional light is still useful for shadows (optional).
    ...
    // Load HDR environment map for ambient lighting and reflections
    ...
    new RGBELoader()
        ...
        .load('2k.hdr', (hdrMap) => {
            const hdrCubeRenderTarget = pmremGenerator.fromEquirectangular(hdrMap);
